...
public partial class GameEntity {
    ...
    public SemoGames.Audio.AudioSourceComponent audioSource { get { return (SemoGames.Audio.AudioSourceComponent)GetComponent(GameComponentsLookup.AudioSource); } }
    ...
    public void AddAudioSource(UnityEngine.AudioSource newValue) {
        ...
        var component = (SemoGames.Audio.AudioSourceComponent)CreateComponent(index, typeof(SemoGames.Audio.AudioSourceComponent));
