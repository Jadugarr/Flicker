...
public partial class GameContext {
    ...
    public SemoGames.GameScene.CurrentSceneComponent currentScene { get { return currentSceneEntity.currentScene; } }
    public bool hasCurrentScene { get { return currentSceneEntity != null; } }

    public GameEntity SetCurrentScene(UnityEngine.SceneManagement.Scene newValue) {
        if (hasCurrentScene) {
            throw new Entitas.EntitasException("Could not set CurrentScene!\n" + this + " already has an entity with SemoGames.GameScene.CurrentSceneComponent!",
    ...
    public void ReplaceCurrentScene(UnityEngine.SceneManagement.Scene newValue) {
...
public partial class GameEntity {
    ...
    public SemoGames.GameScene.CurrentSceneComponent currentScene { get { return (SemoGames.GameScene.CurrentSceneComponent)GetComponent(GameComponentsLookup.CurrentScene); } }
    public bool hasCurrentScene { get { return HasComponent(GameComponentsLookup.CurrentScene); } }

    public void AddCurrentScene(UnityEngine.SceneManagement.Scene newValue) {
        var index = GameComponentsLookup.CurrentScene;
        var component = (SemoGames.GameScene.CurrentSceneComponent)CreateComponent(index, typeof(SemoGames.GameScene.CurrentSceneComponent));
