...
{
    public class StopInteractingWithFlipperSystem : ReactiveSystem<InputEntity>
    {
        public StopInteractingWithFlipperSystem(IContext<InputEntity> context) : base(context)
        {
        }
        ...
        protected override ICollector<InputEntity> GetTrigger(IContext<InputEntity> context)
        {
            return context.CreateCollector(
                new TriggerOnEvent<InputEntity>(InputMatcher.Interacting, GroupEvent.Removed));
        }
